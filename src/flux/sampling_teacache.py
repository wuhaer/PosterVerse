...
from .model_teacache import Flux
...
def denoise(
    ...
    cnt: int = 0,
    num_steps: int = 50,
    rel_l1_thresh: float = 0.6,    # 0.25 for 1.5x speedup, 0.4 for 1.8x speedup, 0.6 for 2.0x speedup, 0.8 for 2.25x speedup
    accumulated_rel_l1_distance: int = 0,
    previous_modulated_input: int = None,
    previous_residual: int = None
