...
from src.flux.sampling_teacache import denoise, denoise_controlnet, get_noise, get_schedule, prepare, unpack
from src.flux.util_teacache import (
    load_ae,
    load_clip,
    load_flow_model,
    load_t5,
...
class XFluxPipeline:
    ...
    def forward(
        ...
        rel_l1_thresh=0.6,    # 0.25 for 1.5x speedup, 0.4 for 1.8x speedup, 0.6 for 2.0x speedup, 0.8 for 2.25x speedup
    ):
        x = get_noise(
            ...
            if self.controlnet_loaded:
                x = denoise_controlnet(
                    ...
                    **inp_cond,
                    ...
                    cnt=0,
                    num_steps=num_steps,
                    rel_l1_thresh=rel_l1_thresh,    # 0.25 for 1.5x speedup, 0.4 for 1.8x speedup, 0.6 for 2.0x speedup, 0.8 for 2.25x speedup
