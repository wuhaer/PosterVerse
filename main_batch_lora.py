...
def img_gen(prompt, args, xflux_pipeline):
    ...
    if True:
        print('load lora:', args.lora_path, args.lora_repo_id, args.lora_name)
        xflux_pipeline.set_lora(args.lora_path, args.lora_repo_id, args.lora_name, args.lora_weight)
    ...
    random_seed = random.randint(0, 1147483647) 
